...
"	background-color: qlineargradient(x0:0, y0:1, x1:1, y1:1,stop:0.4  #222831, stop:1 #30475E);\n"
...
"}")
        ...
        self.LeftMenuBg.setMinimumSize(QSize(205, 0))
        self.LeftMenuBg.setMaximumSize(QSize(205, 16777215))
...
"border-radius:10px")
        icon = QIcon()
        icon.addPixmap(QPixmap("./img/logo.png"), QIcon.Normal, QIcon.Off)
...
"color: rgba(255, 255, 255, 255);")
        ...
        self.Title.setGeometry(QRect(70, 10, 121, 30))#left,top,right,bottom
...
"color: rgba(255, 255, 255, 255);")
        ...
        # self.ToggleBotton.setMinimumSize(QSize(0, 25))
...
# "}")
        ...
        self.src_file_button.setMinimumSize(QSize(0, 25))
...
"}")
        ...
        self.src_cam_button.setMinimumSize(QSize(0, 25))
...
"}")
        ...
        self.src_rtsp_button.setMinimumSize(QSize(0, 25))
...
"}")
        ...
        # self.verticalLayout_5.setStretch(0, 0.1)
...
"")
        ...
        # self.char_label.setStylseSheet(u"padding-left:12px;")
...
"}")
        ...
        #----------------------------------------------
#         self.Liquidity_QF = QFrame(self.QF_Group)
#         self.Liquidity_QF.setObjectName(u"Liquidity_QF")
#         self.Liquidity_QF.setMinimumSize(QSize(170, 80))
#         self.Liquidity_QF.setMaximumSize(QSize(170, 80))
#         self.Liquidity_QF.setToolTipDuration(0)
# #         self.Liquidity_QF.setStyleSheet(u"QFrame#Liquidity_QF{\n"
...
# # "}\n"
# # "")
#         self.Liquidity_QF.setFrameShape(QFrame.StyledPanel)
#         self.Liquidity_QF.setFrameShadow(QFrame.Raised)
#         self.verticalLayout_7 = QVBoxLayout(self.Liquidity_QF)
#         self.verticalLayout_7.setSpacing(0)
#         self.verticalLayout_7.setObjectName(u"verticalLayout_7")
#         self.verticalLayout_7.setContentsMargins(0, 0, 0, 0)
#         self.Liquidity_top = QFrame(self.Liquidity_QF)
#         self.Liquidity_top.setObjectName(u"Liquidity_top")
#         self.Liquidity_top.setStyleSheet(u"border:none")
#         self.Liquidity_top.setFrameShape(QFrame.StyledPanel)
#         # self.Liquidity_top.setFrameShadow(QFrame.Raised)
#         self.horizontalLayout_6 = QHBoxLayout(self.Liquidity_top)
#         self.horizontalLayout_6.setSpacing(0)
#         self.horizontalLayout_6.setObjectName(u"horizontalLayout_6")
#         self.horizontalLayout_6.setContentsMargins(0, 3, 0, 3)
#         self.label_liquidity= QLabel(self.Liquidity_top)
#         self.label_liquidity.setObjectName(u"label_liquidity")
#         self.label_liquidity.setMaximumSize(QSize(16777215, 30))
#         font2 = QFont()
#         font2.setFamilies([u"Segoe UI"])
#         font2.setPointSize(16)
#         font2.setBold(True)
#         font2.setItalic(False)
#         self.label_liquidity.setFont(font2)
#         self.label_liquidity.setStyleSheet(u"color: rgba(255, 255, 255,210);\n"
# "padding-left:12px;\n"
# "font: 700 italic 16pt \"Segoe UI\";")
#         self.label_liquidity.setAlignment(Qt.AlignCenter)
#         self.label_liquidity.setIndent(0)

#         self.horizontalLayout_6.addWidget(self.label_liquidity)


#         self.verticalLayout_7.addWidget(self.Liquidity_top)

#         self.line_liquidity = QFrame(self.Liquidity_QF)
#         self.line_liquidity.setObjectName(u"line_liquidity")
#         self.line_liquidity.setMaximumSize(QSize(16777215, 1))
#         self.line_liquidity.setStyleSheet(u"background-color: rgba(255, 255, 255, 89);")
#         self.line_liquidity.setFrameShape(QFrame.HLine)
#         self.line_liquidity.setFrameShadow(QFrame.Sunken)

#         self.verticalLayout_7.addWidget(self.line_liquidity)

#         self.Liquidity_bottom = QFrame(self.Liquidity_QF)
#         self.Liquidity_bottom.setObjectName(u"Liquidity_bottom")
#         self.Liquidity_bottom.setStyleSheet(u"border:none")
#         self.Liquidity_bottom.setFrameShape(QFrame.StyledPanel)
#         self.Liquidity_bottom.setFrameShadow(QFrame.Raised)
#         self.verticalLayout_8 = QVBoxLayout(self.Liquidity_bottom)
#         self.verticalLayout_8.setSpacing(0)
#         self.verticalLayout_8.setObjectName(u"verticalLayout_8")
#         self.verticalLayout_8.setContentsMargins(0, 6, 0, 6)
#         self.Liquidity_type = QLabel(self.Liquidity_bottom)
#         self.Liquidity_type.setObjectName(u"Liquidity_type")
#         self.Liquidity_type.setMinimumSize(QSize(0, 30))
#         self.Liquidity_type.setMaximumSize(QSize(16777215, 30))
#         font3 = QFont()
...
#         self.Liquidity_type.setFont(font3)
#         self.Liquidity_type.setStyleSheet(u"color: rgb(255, 255, 255);\n"
# "font: 17pt \"Microsoft YaHei UI\";")
#         self.Liquidity_type.setAlignment(Qt.AlignCenter)

#         self.verticalLayout_8.addWidget(self.Liquidity_type, 0, Qt.AlignTop)


#         self.verticalLayout_7.addWidget(self.Liquidity_bottom)

#         self.verticalLayout_7.setStretch(1, 2)
#         self.verticalLayout_7.setStretch(2, 1)

#         self.horizontalLayout_3.addWidget(self.Liquidity_QF)
        #---------------------------------------------
...
"")
        ...
        self.pre_video.setMinimumSize(QSize(200, 300))
...
"border-radius:15px")
        ...
        self.res_video.setMinimumSize(QSize(200, 300))
...
#_------------------------------------------------
        self.Visualize_QF = QFrame(self.content)
        self.Visualize_QF.setObjectName(u"Visualize_QF")
        self.Visualize_QF.setStyleSheet(u"")
        self.Visualize_QF.setFrameShape(QFrame.StyledPanel)
        self.Visualize_QF.setFrameShadow(QFrame.Raised)
        self.verticalLayout_17 = QVBoxLayout(self.Visualize_QF)
        self.verticalLayout_17.setSpacing(0)
        self.verticalLayout_17.setObjectName(u"verticalLayout_16")
        self.verticalLayout_17.setContentsMargins(0, 0, 0, 0)
        
#         self.count = QLabel(self.verticalLayout_17s)
#         self.count.setObjectName(u"count")
#         self.count.setMinimumSize(QSize(200, 100))
#         self.count.setStyleSheet(u"background-color: rgb(238, 242, 255);\n"
# "border:2px solid rgb(255, 255, 255);\n")
# # "border-radius:15px")
#         self.count.setAlignment(Qt.AlignCenter)
#         self.splitter1.addWidget(self.count)
#         self.des = QLabel(self.splitter1)
#         self.des.setObjectName(u"des")
#         self.des.setMinimumSize(QSize(200, 100))
#         self.des.setStyleSheet(u"background-color: rgb(238, 242, 255);\n"
# "border:2px solid rgb(255, 255, 255);\n"
# "border-radius:15px")
#         self.des.setAlignment(Qt.AlignCenter)
#         # self.splitter1.addWidget(self.des)

#         self.verticalLayout_17.addWidget(self.splitter1)

        self.main_content.addWidget(self.Visualize_QF)
#---------------------------------------------------
...
"background-color: qradialgradient(cx:0, cy:0, radius:1, fx:0.1, fy:0.1, stop:0 #76ABAE,  stop:1 #31363F);\n"
...
"        }")
        ...
        self.verticalLayout_5.addWidget(self.Model_QF_2)
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.IOU_QF)
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.Conf_QF)
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.Delay_QF)
...
"        }")
        ...
        self.visual_button.setStyleSheet(u"QCheckBox {\n"
"color: rgba(255, 255, 255, 199);\n"
"font: 590 10pt \"Nirmala UI\";\n"
"        }\n"
"\n"
...
"        }")
        ...
        self.verticalLayout_5.addWidget(self.Save_QF)
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText(QCoreApplication.translate("MainWindow", u"Settings", None))
        self.Title.setText(QCoreApplication.translate("MainWindow", u"Digital Platform", None))
        ...
        # self.label_liquidity.setText(QCoreApplication.translate("MainWindow", u"Liquidity", None))

        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Liquidity", None))
        self.Class_num.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Density", None))
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"About us", None))
